...
public class MetricsUpdateTask implements Subscriber {
    ...
    private MetricCounters updateProjectMetrics(final QueryManager qm, final long oid) {
        ...
        updateCounterWithPolicyViolations(counters, qm.getAllPolicyViolations(project));
     ...
     * @return MetricCounters
     */
    private void updateComponentMetrics(final QueryManager qm, final long oid) {
        ...
        updateCounterWithPolicyViolations(counters, qm.getAllPolicyViolations(component));
    ...
    private void updateCounterWithPolicyViolations(MetricCounters counters, List<PolicyViolation> violations) {
